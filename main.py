...
def generate_group_of_squares(image, square_size, border_width, area_position, area_size, area_color, num_squares):
    """
    在指定区域内生成一组正方形边框
    """
    ...
    total_width = (square_size - border_width) * num_squares + border_width * (num_squares - 1)
...
if __name__ == "__main__":
    ...
    # 生成3到8个正方形边框在指定区域内随机放置
    num_squares = random.randint(3, 8)
    generate_group_of_squares(a4_image, square_size, border_width, area_position, area_size, area_color, num_squares)
